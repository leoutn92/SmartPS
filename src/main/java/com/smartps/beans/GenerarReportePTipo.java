...
@ManagedBean
@RequestScoped
public class GenerarReportePTipo {
//GenerarReportePTipo = GenerarReportePlanesPorTipoDeActividad_hdu7 
	...
	//Redireccion
		if (resultlist.size()==0){
			return "estPTporTipoNohay";
		} else {
			return "estPTporTipoListado";
		}
