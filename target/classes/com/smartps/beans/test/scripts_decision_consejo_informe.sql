...
insert into ps(legajo,id_area,id_estado,id_org,id_tipo_actividad,ciclo_lectivo,cuatrimestre,titulo,nro_disposicion) values (18671,1,6,1,1,2016,2,"prueba",0);
insert into informeFinal(id_ps,fecha_presentacion) values (1,"2016-9-1")
